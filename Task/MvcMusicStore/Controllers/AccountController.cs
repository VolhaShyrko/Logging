...
namespace MvcMusicStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    var counterHelper =
                        PerformanceCounterHelper.PerformanceHelper.CreateCounterHelper<Counter>("TestProject");

                    counterHelper.Increment(Counter.Login);
                    counterHelper.Increment(Counter.OnlineUsers);
                ...
                this.logger.Error("Invalid credentials are passed");
            }
        ...
        public ActionResult LogOff()
        {
            ...
            var counterHelper = PerformanceCounterHelper.PerformanceHelper.CreateCounterHelper<Counter>("TestProject");
            counterHelper.Increment(Counter.Logoff);
            counterHelper.Decrement(Counter.OnlineUsers);
